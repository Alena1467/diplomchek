...
<head>
    ...
    <title>Авдеева Наталья Викторовна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/avd.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 28.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Наталье Авдеевой</p>
                            <form method="POST" action="{{ route('submit-record1') }}" class="formchto">
                                @csrf
                                <div class="form-fio">
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="1">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descriptionavd') }}" method="POST" class="form_push">
                                @csrf
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    ...
                    <h2>Ведущий стоматолог-терапевт, эндонист. Стаж 23 года</h2>
                    <p>Наталья Викторовна — самый востребованный стоматолог в Челябинске. За годы работы она помогла более 7 000 пациентов обрести здоровую и красивую улыбку, решила более 1 000 сложных клинических случаев с использованием передовых технологий на базе группы клиник «Стомпрактика».
                    Также Наталья Авдеева преподает в учебном центре GlobalClass, имеет почетное звание «Заслуженный работник».
                    Наталья Викторовна ведет прием в клинике премиум-уровня Maxima Clinique, входящей в группу СТОМПРАКТИКА.РФ.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>01.01.1992 Челябинское медицинское училище. Стоматология, зубной врач. Серия и номер диплома: РТ, 680603.</li>
                        <li>10.04.2020 АНО ДПО "Центральный многопрофильный институт". Стоматология. Номер диплома: 1177242367412.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                        <li>г. Челябинск, ул. Бр. Кашириных, 54г (Maxima Стоматология)</li>
                    </ul>
                    <ul class="sw-marker">
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descriptionavd') }}" method="POST">
                                @csrf
                                @method('DELETE')
