...
<body>
    ...
    <main>
        <div class="implmain">
            ...
            <!-- левая колонка -->
            <div class="leftimpl">
                <h1>Отбеливание<br>зубов</h1>
            </div>

            <!-- правая колонка -->
            <div class="rightimpl">
                <h2>Создание белоснежной улыбки бережными методиками с долговременным <br> эффектом и минимальным количеством противопоказаний.</h2>
                <h3>Полный список наших услуг по данному направлению:</h3>
                <div class="nameuslug">
                    <div class="leftname">
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Отбеливание зубов Philips Zoom! White Speed (Zoom4)</p>
                            </a>
                        </div>
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Домашнее отбеливание зубов с изготовлением индивидуальных кап</p>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="mclr" id="tableprices">
                ...
                <table>
                    <tr>
                        <td>Домашнее отбеливание зубов (с изготовлением капп)</td>
                        <td>от 14 300 ₽</td>
                    </tr>
                    <tr>
                        <td>Отбеливание зубов по технологии Philips Zoom! White Speed (Zoom4)</td>
                        <td>от 36 400 ₽</td>
                    </tr>
                </table>
            </div>
