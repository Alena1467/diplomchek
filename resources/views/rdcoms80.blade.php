...
<head>
    ...
    <link rel="stylesheet" href="./css/receivingdoctors.css">
    <link rel="stylesheet" href="./css/media.css">
    <script src="./js/receivingdoctors.js"></script>
    <title>Комсомольский проспект, 80</title>
...
<body>
    ...
    <main>
        <div class="mclr" id="tableprices">
            <h1>Принимающие врачи по адресу Комсомольский проспект, 80. ООО «СП-Проспект»</h1>
            <table>
                <tr>
                    <td class="ltd">Принимающий врач</td>
                    <td class="rtd">Ближайшая дата приема</td>
                </tr>
                @foreach($doctors as $doctor)
                    <tr>
                        <td class="ltd">{{ $doctor->last_name }} {{ $doctor->first_name }} {{ $doctor->third_name }}</td>
                        <td class="rtd">Дата приема: {{ $doctor->date }}<br>Время приема: {{ $doctor->time }}</td>
                    </tr>
                @endforeach
            </table>
        </div>
