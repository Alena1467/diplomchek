...
<head>
    ...
    <title>Бреднева Юлия Евгеньевна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/bred.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    ...
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            ...
                            <p>Запишитесь на консультацию к Юлии Евгеньевне</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descbred') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="15">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Бреднева Юлия Евгеньевна</h1>
                    <h2>Врач стоматолог детского приема. Стаж 4 года</h2>
                    <p>Доктор специализируется на комплексном проведении детского терапевтического приема, владеет всеми современными методами лечения зубов у детей и подростков, проводит профилактические приемы, профессиональную гигиену полости рта, адаптацию детей перед лечением.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>08.07.2020 ФГБОУ ВО "Южно-Уральский государственный медицинский университет" МЗ РФ г. Челябинск. Стоматология, врач-стоматолог.</li>
                    </ul>
                    <ul class="start-without-marker">
                        <li>Повышение квалификации::</li>
                        <li>Модульный ортодонтический курс Тюковой Анастасии 2019-2020</li>
                        <li>Вебинар «Пульпиты и периодонтиты в детской стоматологии» Дмитрий Киселев, август 2022</li>
                        <li>Семинар «Недетские реставрации детского стоматолога» ноябрь 2021, Яна Фейдман</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descbred') }}" method="POST">
                                @csrf
                                @method('DELETE')
