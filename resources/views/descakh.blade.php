...
<head>
    ...
    <title>Ахмеджанова Эльмира Ильфатовна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/akh.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    ...
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            ...
                            <p>Запишитесь на консультацию к Эльмире Ильфатовне</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descakh') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="8">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Ахмеджанова Эльмира Ильфатовна</h1>
                    <h2>Стоматолог-ортодонт . Стаж 3 года</h2>
                    <p>Детский ортодонт (пациенты до 12 лет). Подберет ортодонические конструкции, которые помогут исправить прикус и выровнять зубы.
                    <br>
                    <br>
                    Ахмеджанова Эльмира Ильфатовна – врач-ортодонт, помогает исправить прикус и сделать зубы ровными при помощи:
                    <br>— Съемных и несъёмных ортодонтических аппаратов;
                    <br>— Сохранителей места (ортодонтических колец);
                    <br>— Пластиночных протезов;
                    <br>— Трейнеров.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>24.06.2022 ФГБОУ ВО "Южно-Уральский государственный медицинский университет" МЗ РФ г. Челябинск. Факультет стоматологии, специальность: врач общей практики.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descakh') }}" method="POST">
                                @csrf
                                @method('DELETE')
