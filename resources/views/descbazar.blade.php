...
<head>
    ...
    <title>Базарова Оксана Анатольевна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/bazar.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 02.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Оксане Анатольевне</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descbazar') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="9">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Базарова Оксана Анатольевна</h1>
                    <h2>Ведущий специалист в области детской стоматологии сети клиник «Стомпрактика». Стаж 30 лет</h2>
                    <p>Оксана Анатольевна Базарова специализируется на лечении молочных и постоянных зубов у детей до 15 лет. На её счету более 12 000 успешных процедур.
                    <br>
                    <br>
                    За успехи на профессиональном поприще Оксана Анатольевна была удостоена звания «Отличник стоматологии I степени», выдаваемого Стоматологической ассоциацией России. Оксана Анатольевна умеет найти подход к любому маленькому пациенту.
                    <br>
                    <br>
                    В свободное время занимается цветоводством.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>01.01.1994 Челябинское медицинское училище. Стоматология, зубной врач. Номер диплома: УТ № 079116.</li>
                        <li>28.12.2020 АНО ДПО "Центральный многопрофильный институт". Стоматология. Серия и номер: 117724, 2867070.</li>
                    </ul>
                    <ul class="start-without-marker">
                        <li>Повышение квалификации::</li>
                        <li>2021 г. – «Моделирование поведения и влияние на отношение ребенка к стоматологическому лечению. Особенности организации детского приема», г. Москва.</li>
                        <li>2020 г. – «Травмы, эстетическая реставрация», г. Челябинск.</li>
                        <li>2019 г. – «Эндодонтия молочного прикуса», «Комплекс детской профессиональной гигиены», г. Москва.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                        <li>г. Челябинск, ул. Бр. Кашириных, 54г (BabyDent)</li>
                    </ul>
                    <ul class="sw-marker">
                        ...
                        <li>Лечение пульпита молочного зуба</li>
                        <li>Лечение зубов с применением веселящего газа</li>
                        <li>Консультация детского стоматолога</li>
                        <li>Глубокое фторирование зубов</li>
                        <li>Лечение стоматита у детей</li>
                        <li>Лечение гингивита у детей</li>
                    </ul>
                </div>
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descbazar') }}" method="POST">
                                @csrf
                                @method('DELETE')
