...
<head>
    ...
    <title>Буймистрова Инга Геннадьевна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/buim.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    ...
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            ...
                            <p>Запишитесь на консультацию к Инге Геннадьевне</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descbuim') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="16">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Буймистрова Инга Геннадьевна</h1>
                    <h2>Стоматолог-терапевт. Стаж 7 лет</h2>
                    <p>Проводит комфортное лечение кариеса и его осложнений с применением современных технологий и материалов
                    <br> — Инга Буймистрова – специалист по лечению кариеса, некариозных поражений, а также эндодонтических заболеваний (пульпит, периодонтит).
                    <br> — Общий стаж работы более 5 лет.
                    <br> — Инга Геннадьевна внимательно и чутко относится к каждому пациенту.
                    <br> — Ее принцип – индивидуальный подход и оптимальное решение для каждой клинической ситуации.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>30.06.2017 ФГБОУ ВО "Южно-Уральский государственный медицинский университет" МЗ РФ г. Челябинск. Стоматология общей практики, врач-стоматолог.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                        <li>г. Челябинск, ул. 40 лет Победы, 36</li>
                        <li>г. Челябинск, ул. Университетская Набережная, 52</li>
                    </ul>
                    <ul class="sw-marker">
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descbuim') }}" method="POST">
                                @csrf
                                @method('DELETE')
