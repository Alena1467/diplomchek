...
<body>
    ...
    <main>
        <div class="implmain">
            ...
            <!-- левая колонка -->
            <div class="leftimpl">
                <h1>Удаление<br>зубов</h1>
            </div>

            <!-- правая колонка -->
            <div class="rightimpl">
                <h2>Проведение безболезненных операций по бережному удалению зубов ведущими <br> хирургами-стоматологами Челябинска и УрФО.</h2>
                <h3>Полный список наших услуг по данному направлению:</h3>
                <div class="nameuslug">
                    <div class="leftname">
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Консультация хирурга-стоматолога</p>
                            </a>
                        </div>
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Удаление зуба мудрости</p>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="mclr" id="tableprices">
                ...
                <table>
                    <tr>
                        <td>Удаление кисты зуба</td>
                        <td>от 2 150 ₽</td>
                    </tr>
                    <tr>
                        <td>Закрытый синус-лифтинг (наращивание костной ткани)</td>
                        <td>от 21 300 ₽</td>
                    </tr>
                    <tr>
                        <td>Открытый синус-лифтинг (наращивание костной ткани)</td>
                        <td>от 83 110 ₽</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Сложное удаление зуба</td>
                        <td>от 8 040 ₽</td>
                    </tr>
                    <tr>
                        <td>Удаление непрорезавшегося, дистопированного или сверхкомплектного зуба</td>
                        <td>от 11 240 ₽</td>
                    </tr>
                </table>
            </div>
