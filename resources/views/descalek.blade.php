...
<head>
    ...
    <title>Алексеева Наталья Игоревна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/alek.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 10.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Наталье Алексеевой</p>
                            <form method="POST" action="{{ route('submit-record3') }}" class="formchto">
                                @csrf
                                <div class="form-fio">
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="3">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descalek') }}" method="POST" class="form_push">
                                @csrf
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Алексеева Наталья Игоревна </h1>
                    <h2>Стоматолог-терапевт. Стаж 14 лет</h2>
                    <p>Наталья Игоревна регулярно проходит курсы повышения квалификации.
                    — Искусство прямых реставраций жевательной группы зубов. Курс Карпенко.
                    — Эндодонтия от А до Я. Damiano Pasquatini.
                    — Композитные виниры. Курс Чайка З.
                    — Методика безопасного извлечения фрагментов сломанных эндодонтических иструментов из корневых каналов. Курс Земляковой О.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>24.06.2010 ГБОУ СПО "Миасский медицинский колледж" г. Миасс. Зубной врач.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descalek') }}" method="POST">
                                @csrf
                                @method('DELETE')
