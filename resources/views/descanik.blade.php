...
<head>
    ...
    <title>Аникина Наталья Алексеевна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/anik.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 07.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Наталье Алексеевне</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descanik') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="6">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Аникина Наталья Алексеевна</h1>
                    <h2>Гигиенист стоматологический. Стаж 7 лет</h2>
                    <p>Специалист по профилактике заболеваний зубов и десен. Проводит все виды профессиональной гигиены полости рта.</p>
                    <ul class="start-without-marker">
                        <li>Повышение квалификации:</li>
                        <li>2022 г. Вебинар KERR "Некариозные поражения твердых тканей зубов"</li>
                        <li>2022 г. Семинар для врачей стоматологов "Профессиональный гигиенический уход во время ортодонтического лечения"</li>
                        <li>2022 г. Екатеринбург. "Разные инструменты в пародонтологии"</li>
                        <li>2022 г. Екатеринбург. "iTop 1 уровень"</li>
                        <li>2022 г. "Гигиена полости рта. развенчивание мифов"</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                        <li>г. Челябинск, Комсомольский проспект, 80.</li>
                        <li>
                        ул. Университетская Набережная, 52</li>
                    </ul>
                    <ul class="sw-marker">
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descanik') }}" method="POST">
                                @csrf
                                @method('DELETE')
