...
<head>
    ...
    <title>Атаманчук Дарья Александровна</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/Atam.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 22.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Дарье Александровне</p>
                            <form id="popupForm">
                                ...
                                <input type="hidden" name="doctor" value="Атамнчук Дарья Александровна">
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descatam') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="7">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Атаманчук Дарья Александровна</h1>
                    <h2>Стоматолог-терапевт.</h2>
                    <p>Доктор придерживается индивидуального подхода и бережного отношения к каждому пациенту. </p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>25.06.2023 ЮУГМУ. Стоматологический факультет. Врач стоматолог.</li>
                    </ul>
                    <ul class="start-without-marker">
                        <li>Повышение квалификации:</li>
                        <li>Диагностика и лечение кариеса. Маркова Н., Виноградова И., Гусева О.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                        <li>г. Челябинск, пл. МОПРа, 9</li>
                    </ul>
                    <ul class="sw-marker">
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descatam') }}" method="POST">
                                @csrf
                                @method('DELETE')
