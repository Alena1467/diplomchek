...
<head>
    ...
    <title>Барышников Анатолий Иванович</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/barysh.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    ...
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            ...
                            <p>Запишитесь на консультацию к Анатолию Ивановичу</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descbarysh') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="10">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Барышников Анатолий Иванович</h1>
                    <h2>Стоматолог-ортопед. Стаж 4 года</h2>
                    <p>Специализируется на зубном протезировании с использованием современных технологий.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>10.07.2020 ФГБОУ ВО "Южно-Уральский государственный медицинский университет" МЗ РФ г. Челябинск. Врач-стоматолог.</li>
                        <li>08.07.2022 ФГБОУ ВО "Башкирский государственный медицинский университет". Врач-стоматолог-ортопед.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                    ...
                    <ul class="sw-marker">
                        ...
                        <li>Металлокерамические зубные коронки</li>
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descbarysh') }}" method="POST">
                                @csrf
                                @method('DELETE')
