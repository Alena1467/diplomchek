...
<head>
    ...
    <title>Анестезия и наркоз</title>
...
<body>
    ...
    <main>
        <div class="implmain">
            ...
            <!-- левая колонка -->
            <div class="leftimpl">
                <h1>Анестезия и наркоз при лечении зубов</h1>
            </div>

            <!-- правая колонка -->
            <div class="rightimpl">
                <h2>Лечение зубов с максимальным комфортом и под пристальным вниманием врачей. Ваше здоровье в надежных руках!</h2>
                <h3>Полный список наших услуг по данному направлению:</h3>
                <div class="nameuslug">
                    <div class="leftname">
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Консультация анестезиолога</p>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="mclr" id="tableprices">
                ...
                <table>
                    <tr>
                        <td>Проведение стоматологического лечения под наркозом (30 минут) для взрослых</td>
                        <td>от 6 000 ₽</td>
                    </tr>
                    <tr>
                        <td>Проведение стоматологического лечения под наркозом (30 минут) для детей</td>
                        <td>от 2 500 ₽</td>
                    </tr>
                    <tr>
                        <td>Седация закисью азота (30 минут)</td>
                        <td>от 2 500 ₽</td>
                    </tr>
                    <tr>
                        <td>Местная анестезия "OralBlok"</td>
                        <td>от 1 250 ₽</td>
                    </tr>
                </table>
            </div>
