...
<body>
    ...
    <main>
        <div class="implmain">
            ...
            <!-- левая колонка -->
            <div class="leftimpl">
                <h1>Лечение<br>десен</h1>
            </div>

            <!-- правая колонка -->
            <div class="rightimpl">
                <h2>Качественное лечение всех видов пародонтологических заболеваний.</h2>
                <h3>Полный список наших услуг по данному направлению:</h3>
                <div class="nameuslug">
                    <div class="leftname">
                        <div class="cardname">
                            <a href="{{route('record')}}">
                                <p>Лечение всех видов пародонтологических заболеваний</p>
                            </a>
                        </div>
                    </div>
                </div>
