...
<head>
    ...
    <title>Бейнарович Станислав Викторовичы</title>
...
<body>
    ...
    <main>
        ...
        <div class="procheedisc">
            <div class="discr">
                <div class="avatar">
                    <img src="./img/bein.jpg" alt="Avatar">
                </div>
                <div class="rec">
                    <p>Ближайшая дата приема 20.07.2024</p>
                    <button class="recbtnvr" id="recordButton">Записаться</button>
                    <div id="popupContainer" style="display: none;">
                        <div id="popup">
                            <span class="close-btn">&times;</span>
                            <p>Запишитесь на консультацию к Станиславу Викторовичу</p>
                            <form id="popupForm">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('descbein') }}" method="POST" class="form_push">
                                @csrf
                                ...
                                <input type="hidden" name="doctor" id="doctor" value="12">
        ...
        <div class="maindiscription">
            <div class="mainds">
                ...
                <div class="opisvracha">
                    <h1>Бейнарович Станислав Викторович</h1>
                    <h2>Стоматолог-ортопед. Стаж 15 лет</h2>
                    <p>Для Станислава Викторовича стоматолог-ортопед — не просто профессия. Он обладает уникальным видением решения задач с использованием новейших мировых методик. Станислав Викторович регулярно повышает свою квалификацию без отрыва от врачебной практики. Благодаря полученным навыкам может найти выход даже в сложных клинических ситуациях.</p>
                    <ul class="start-without-marker">
                        <li>Образование:</li>
                        <li>18.06.2009 ГОУ ВПО "Челябинская государственная медицинская академия Федерального агентства по здравоохранению и социальному развитию". Стоматология.</li>
                        <li>28.12.2020 АНО ДПО "Центральный многопрофильный институт". Стоматология ортопедическая.</li>
                    </ul>
                    <ul class="sw-marker">
                        <li>Где принимает:</li>
                ...
                <div class="container">
                    ...
                    @else
                        @foreach($reviewDate as $review)
                            ...
                            <form action="{{ route('descbein') }}" method="POST">
                                @csrf
                                @method('DELETE')
