...
class DescbakhController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descbakh');
        ...
        return view('descbakh', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descbakh')->with('success', 'Ваши данные успешно отправлены.');
    }
}
