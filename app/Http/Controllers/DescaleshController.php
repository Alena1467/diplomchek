...
class DescaleshController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descalesh');
            ...
            // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
            return redirect()->route('descaleshd');
        }
        ...
        return view('descalesh', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descalesh')->with('success', 'Ваши данные успешно отправлены.');
    }
}
