...
class DescatamController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descatam');
        ...
        return view('descatam', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descatam')->with('success', 'Ваши данные успешно отправлены.');
    }
}
