...
class DescanikController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descanik');
        ...
        return view('descanik', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descanik')->with('success', 'Ваши данные успешно отправлены.');
    }
}
