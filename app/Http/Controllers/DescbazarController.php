...
class DescbazarController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descbazar');
        ...
        return view('descbazar', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descbazar')->with('success', 'Ваши данные успешно отправлены.');
    }
}
