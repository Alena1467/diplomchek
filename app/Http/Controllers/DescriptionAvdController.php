...
class DescriptionAvdController extends Controller
{
    public function showReview(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('descriptionavd');
        ...
        return view('descriptionavd', compact('reviewDate'));
    }
    ...
    public function submitRecord(Request $request)
    {
        ...
        // Перенаправляем на ту же страницу для предотвращения повторной отправки формы
        return redirect()->route('descriptionavd')->with('success', 'Ваши данные успешно отправлены.');
    }
}
